...
import { selectStageGroups, selectDagInfo } from '@/execution/selectors';
import { computeStagePositions } from '@/execution/dagLayout';
import { STAGE_PALETTE, EDGE_COLORS } from '@/execution/constants';
import type { Node, Edge, MarkerType } from '@xyflow/react';
import type { StageExecution, AgentExecution } from '@/execution/types';
import type { DagInfo } from '@/execution/selectors';
import type { StagePosition } from '@/execution/dagLayout';
