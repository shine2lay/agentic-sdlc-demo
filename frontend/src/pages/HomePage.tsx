    ...
    <div className="max-w-4xl mx-auto p-8 h-full overflow-auto">
      ...
      <div className="mb-8">
        ...
        <div className="flex gap-3 items-end">
          ...
          />
          <button
            className="bg-[var(--temper-accent)] text-green-400 rounded-lg px-5 py-2 text-sm font-medium whitespace-nowrap hover:opacity-85 disabled:opacity-40 disabled:cursor-not-allowed transition-opacity"
